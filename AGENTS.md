...
> Fork of [guimatheus92/mcp-video-analyzer](https://github.com/guimatheus92/mcp-video-analyzer), adding smart frame selection and an automatic URL-to-local-file fallback. **Not published to npm** — build it locally and run `dist/index.js`.
